...
if __name__ == '__main__':
    ...
    view.setStyleSheet("alternate-background-color: rgb(209, 232, 255);background-color: rgb(177, 210, 242);")
    ...
    with open('..\json_file\data.json', 'r') as f:
        config = json.load(f)
    ...
    # Sanity check
    assert (
        json.dumps(model.json(), sort_keys=False) !=
